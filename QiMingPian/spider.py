...
class QMPSpider:
    def __init__(self):
        self.url = "https://vipapi.qimingpian.com/DataList/investEventVip"
        ua = UserAgent()
        self.headers = {
    ...
    def request(self):
        ...
        try:
            ...
            if res.json()["message"] == "success":
                self.decrypt(res.json()["encrypt_data"])
            else:
    ...
    def decrypt(self, data: str):
        ...
        :return:
        """
        decrypt_data = base64.b64decode(self.js.call('my_decrypt', data))
